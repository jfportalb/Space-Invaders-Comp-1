...
enum SAMPLES {
	SHOOT, TANQUE_EXPLOSION, ALIEN_MOVE_1, ALIEN_MOVE_2, 
	ALIEN_MOVE_3, ALIEN_MOVE_4, ALIEN_EXPLOSION, 
	UFO_HIGHPITCH, UFO_LOWPITCH
};
...
void play_sound(SOUND_MANAGER *sound, SAMPLES sample, ALLEGRO_PLAYMODE playmode);
