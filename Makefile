lall: jogo.o escudo.o alien.o wave.o missil.o tanque.o buffer.o menu.o botao.o space.c
...
wave.o: wave.c wave.h
	g++ -c wave.c
clean:
	rm -f jogo.o escudo.o alien.o missil.o tanque.o vetor.o buffer.o botao.o menu.o wave.o
git:
	git add --all
	git commit
	git push